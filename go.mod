...
require (
	...
	github.com/openstack-k8s-operators/barbican-operator/api v0.5.0
	...
	github.com/openstack-k8s-operators/neutron-operator/api v0.5.0
	...
	github.com/openstack-k8s-operators/test-operator/api v0.5.0
